...
function App() {
  ...
  // O estado 'chatHistory' foi removido
  ...
  const handleSendMessage = async () => {
    ...
    try {
      // ESTE CÓDIGO ENVIA O JSON SIMPLES: {"prompt": "..."}
      const response = await fetch(
        'https://api.arcadepandora.cloud/webhook/7f60ab7c-a4d7-4b2f-9922-3b16e44d8240', 
        {
          ...
          body: JSON.stringify({ prompt: userMessage.text }), // AQUI: Volta a enviar apenas o prompt
        }
      );
